...
# Load the investment base from the JSON file (assuming it's in the same directory)
...
# Example of a realistic user profile for testing
user_profile = {
    'age': '60+',
    'income': 'high',
...
# Perform the RAG to retrieve the most relevant advice based on the user profile
retrieved_advice = retrieve_recommendation(user_profile)
